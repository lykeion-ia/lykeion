/**
 *  - A study opens on the stage-sectioned Table (no board, no view toggle).
...
describe("Study chat entry", () => {
  it("opens a study on the centered chat entry, no board", async () => {
    ...
    expect(screen.queryByTestId("study-board")).not.toBeInTheDocument();
  });
});
