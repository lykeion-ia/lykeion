...
export function createHttpApi(transport: Transport): LykeionApi {
  ...
  return {
    ...
    listResearches: call("listResearches"),
    getResearch: call("getResearch"),
    createResearch: call("createResearch"),
    updateResearch: call("updateResearch"),
    archiveResearch: call("archiveResearch"),
    restoreResearch: call("restoreResearch"),
    deleteResearch: call("deleteResearch"),
    ...
    requestKernelEnvironmentSetup: call("requestKernelEnvironmentSetup"),
    taskEnvironmentSetups: call("taskEnvironmentSetups"),
    retryKernelEnvironmentSetup: call("retryKernelEnvironmentSetup"),
    answerEnvironmentDefaultSuggestion: call("answerEnvironmentDefaultSuggestion"),
    kernelEnvReclaim: call("kernelEnvReclaim"),
    kernelEnvCreate: call("kernelEnvCreate"),
    kernelEnvDelete: call("kernelEnvDelete"),
